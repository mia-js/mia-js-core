            ...
            setValuesAndInsert: function (values, options, callback) {
                ...
                self.setValues(values, options, function (err, data) {
                    if (err) {
                        ...
                        self.insertOne(options, callback);
                    }
                });
                    ...
                    if (err) {
                        ...
                        self.schema.validate(query, {query: true, partial: true}, function (err, validatedQuery) {
                            if (err) {
                                ...
                                self.updateOne(validatedQuery, options, callback);
                            }
                        });
...
//            },
            ...
            insertOne: function (options, callback) {
                var self = this;
                return self.schema._insertOneRaw(self.data, options, callback);
            },
             ...
             * @param callback
             */
            updateOne: function (query, options, callback) {
                var self = this;
                return self.schema._updateOneRaw(query, self.data, options, callback);
            }
        },
        //==================================
        // Schema members
        //==================================
        {
                ...
                self.collection(function (err, collection) {
                    if (err) {
                        ...
                        Async.each(indexNodesArray, function (path, iterationCompleteCb) {
                            ...
                            collection.createIndex(paths, {unique: isUnique, sparse: isSparse}, iterationCompleteCb);
                        }, callback);
                    }
                });
             ...
             * @api public
             */
            insertOne: function (docs, options, callback) {
                var self = this;
                var args = ArgumentHelpers.prepareArguments(options, callback);
                options = args.options;
                ...
                if (options.validate === false) {
                    ...
                    result = self._insertOneRaw(docs, options);
                }
                else {
                    result = self.validate(docs, options).then(function (validatedDocs) {
                        return self._insertOneRaw(validatedDocs, options);
                    });
                }
            ...
            updateOne: function (query, docs, options, callback) {
                var self = this;
                var args = ArgumentHelpers.prepareArguments(options, callback);
                options = args.options;
                callback = args.callback;
            ...
            _insertOneRaw: function () {
                return this._callGeneric('insertOne', arguments);
            },

            _updateOneRaw: function () {
