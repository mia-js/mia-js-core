    ...
    describe("Derived model", function () {
        ...
        describe("Testing model/instance db methods:", function () {
            ...
            describe("SetValues", function () {
                it("must return validated document", function (next) {
                    ...
                    runs(function () {
                        expect(function () {
                            ...
                            values['culture']['language'] = 'ab';
                            values['culture']['region'] = 'ca';
                            values['appversion'] = 19;

                            modelInstance.setValues(values, function (err, dta) {
                                data = dta;
                                error = err;
                                done = true;
                            });
                    ...
                    waitsFor(function () {
                        return done;
                    }, "modelInstance.setValues", 3000);

                    //evaluate results
                    runs(function () {
                        expect(error == null).toBeTruthy();
                        expect(data.appversion).toEqual('19');
            ...
            describe("Inserting objects", function () {
                ...
                it("inserting validated document", function (next) {
                    runs(function () {
                        expect(function () {
                            var values = {};
                            values.userId = '1';
                            ...
                            modelInstance.setValues(values, function (err, dta) {
                                ...
                                modelInstance.insert(function (err, dta) {
                                    data = dta;
                                    error = err;
                                    done = true;
                                });
                ...
                it("inserting validated document with setValuesAndInsert", function (next) {
                    runs(function () {
                        expect(function () {
                            var values = {};
                            values.userId = '2';
                            values['culture'] = {};
                            values['culture.code'] = 'de-de';
                            values['culture']['language'] = 'bc';
                            values['culture']['region'] = 'ca';
                            values['appversion'] = 19;

                            modelInstance.setValuesAndInsert(values, function (err, dta) {
                                data = dta;
                                error = err;
                                done = true;
                            });
                ...
                it("updating validated document with setValuesAndUpdate", function (next) {
                    runs(function () {
                        expect(function () {
                            var values = {};
                            values.userId = '3';
                            values['culture'] = {};
                            values['culture.code'] = 'de-de';
                            values['culture']['language'] = 'cd';
                            values['culture']['region'] = 'ca';
                            values['appversion'] = 19;

                            modelInstance.setValuesAndUpdate({userId: values.userId}, values, function (err, dta) {
                                data = dta;
                                error = err;
                                done = true;
                            });
