var Shared = require('mia-js-core/node_modules/shared')
    , Q = require('q')
    , _ = require("lodash")
    , ModelValidator = require("mia-js-core/node_modules/modelValidator");
...
function ThisModule() {
    ...
    var checkPreconditions = function (req, res, next) {
        ...
        if (routeFound == false) {
            MiaJs.Logger('err', 'Can not find controller file in preconditionsCheck to perform parameter validation. Request canceled due to security reasons');
            next({status: 500});
            return;
        }
    };
