...
function thisModule() {
    ...
    self.config = function (path) {
        ...
        if (!path) {
            ...
            return MemberHelpers.getPathPropertyValue(_shared.config, path);
        }
    };
    //</editor-fold>
    ...
    self.libs = function (path) {
        ...
        if (!path) {
            ...
            return MemberHelpers.getPathPropertyValue(_shared.libs, path);
        }
    };
    //</editor-fold>
    ...
    self.controllers = function (path) {
        ...
        if (!path) {
            ...
            return MemberHelpers.getPathPropertyValue(_shared.controllers, path);
        }
    };
    //</editor-fold>
    ...
    self.cronModules = function (path) {
        ...
        if (!path) {
            ...
            return MemberHelpers.getPathPropertyValue(_shared.cronModules, path);
        }
    };
    //</editor-fold>
    ...
    self.memcached = function () {
        if (!_memcached) {
            _memcached = new Memcached(self.config('environment.memcached.servers'), self.config('environment.memcached.options'));

            if (self.config('environment.memcached.flushOnStart') === true) {
