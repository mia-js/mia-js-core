var Trycatch = require('trycatch')
    ...
    , ErrorHandler = require("mia-js-core/lib/errorHandler")
    , Logger = require('mia-js-core/lib/logger')
    , _ = require('lodash')
    , Shared = require('mia-js-core/lib/shared')
    , IPAddressHelper = require('mia-js-core/lib/utils').IPAddressHelper
    , Translator = require('mia-js-core/lib/translator')
    , Utils = require('mia-js-core/lib/utils')
    , RateLimiter = require('mia-js-core/lib/rateLimiter')
                    ...
                    if (parametersList[section] && parametersList[section][name]) {
                        ...
                        for (var attr in addCondition) {
                            if (!parametersList[section][name][attr]) {
                                ...
                                if (parametersList[section][name][attr] != addCondition[attr]) {
