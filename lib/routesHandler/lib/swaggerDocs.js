        ...
        for (var hostId in hosts) {
            ...
            if (!_.isEmpty(swaggerDocResult)) {
                ...
                SwaggerTools.initializeMiddleware(swaggerDocResult, function (swaggerMiddleware) {
                    ...
                    hosts[hostId]["router"].use(function (req, res, next) {
                        var maxAge = 0;
                    ...
                    hosts[hostId]["router"].use(swaggerMiddleware.swaggerMetadata());
                    ...
                    hosts[hostId]["router"].use(swaggerMiddleware.swaggerUi());
