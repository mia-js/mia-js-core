...
module.exports = BaseCronJob.extend({},
    {
        ...
        staticConstructor:  function ()  {
            ...
            const _cleanServers =  () => {
                ...
                return JobManagementDbConnector.doHeartbeat(initialServerUniqueId).fail(err => {
                    ...
                    return JobManagementDbConnector.cleanJobsOfDeadServers(_deathInterval).then(result => {
                        if (result.length > 0) {
