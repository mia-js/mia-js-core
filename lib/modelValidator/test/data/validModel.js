...
function thisModule() {
    ...
    var model = BaseModel.extend({
            data: {
                ...
                allowMultipleValues1: {
                    type: String,
                    allowMultiple: [1, 2, 3, 4, 5, 6]
                },
                allowMultipleValues2: {
                    type: Number,
                    allowMultiple: [1, 2, 3, 4, 5, 6]
                },
                allowMultipleValues3: {
                    type: String,
                    allowMultiple: [1, 2, 'testAllowCAPS']
                },
                allowMultipleValues4: {
                    type: String,
                    allowMultiple: [1, 2, 'testvaluecaps']
                }
            }
        },
        {
