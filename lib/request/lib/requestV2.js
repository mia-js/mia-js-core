...
function thisModule() {
    ...
    var _do = function (requestOptions, callback) {
        ...
        if (!requestOptions.options) {
            callback(new MiaError({ name: 'ApplicationException', err: "'requestOptions.options' is missing" }));
            return;
        }
        ...
        if (!requestOptions.options.hostname) {
            callback(new MiaError({ name: 'ApplicationException', err: "'requestOptions.options.hostname' is missing" }));
            return;
        }
        if (!requestOptions.options.path) {
            callback(new MiaError({ name: 'ApplicationException', err: "'requestOptions.options.path' is missing" }));
            return;
        }
        ...
        req.on('socket', function (socket) {
            socket.setTimeout(requestOptions.timeout, function () {
