module.exports.Run = require('./lib/mia-js');
...
module.exports.DbAdapters = require('./lib/dbAdapters');
module.exports.ModuleLoader = require('./lib/moduleLoader');
module.exports.CronJobs = require('./lib/cronJobs');
